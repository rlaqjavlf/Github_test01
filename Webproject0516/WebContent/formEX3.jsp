...
<body>
	<div id=container>
		<div id=contant>
		<form action="Controller.jsp" method="post" id="frm" enctype="">
			<td id ="title">아이디</td>
			...
			<td id ="title">성별</td>
				<input type = "radio" name = "usergander" value="남" checked>남
				<input type = "radio" name = "usergander" value="여" checked>여<br>
